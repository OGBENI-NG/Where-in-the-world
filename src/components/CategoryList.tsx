...
const CategoryList: React.FC<CategoryListProps> = ({
  ...
  return (
    <ul className="relative flex justify-center gap-4 md:gap-16 items-center text-Dark font-bold text-[15px] leading-none bg-Lightest p-3 md:px-10 ml:gap:8 ml:justify-evenly
