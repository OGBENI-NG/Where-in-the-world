...
const Footer: React.FC = () => {
  ...
  return (
    <footer>
      <section className=' bg-Darkest/95 px-8 py-12 md:py-14 text-Lightest leading-none flex
        flex-col justify-center gap-12 md:gap-10 md:flex-row'>
        {footIcons}
      </section>
      <section 
        className='md:relative md:px-10 bg-Darkest py-12 overflow-x-hidden 
          text-center  text-Light flex gap-5 flex-col 
          items-center justify-center text-[14px]'>
        <div className='flex flex-col justify-center gap-5 md:flex-row  
          md:items-start md:gap-[75px]'>
          <div>
          ...
          <div className=''>
            <p>Payment methods</p>
            <div className='flex items-center gap-5 text-Mid/75 pt-1'>
