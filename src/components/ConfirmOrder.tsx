      ...
      <div className=' bg-Lightest h-max w-full md:w-[400px] text-Dark px-4 pb-5 rounded-xl'>
        ...
        <div>
          <div className={`bg-Light/60 p-4 pt-2 rounded-lg  
            ${cart.length > 2 ? "h-[270px] md:h-[268px] overflow-y-scroll" : "h-auto"}`}>
            {cart.map(item => (
              <div key={item.id} className={`${flexDiv} gap-[12px] py-2 border-b-2 border-Mid/50`}>
                ...
                />
                <div >
                  <h2 className='text-[14px] w-[120px] font-bold
                ...
                <p className='ml-auto text-lg md:text-base font-bold text-Darkest'>
        ...
        <div className='w-full text-[15px] font-bold text-Lightest'>
          <div  className={`${flexDiv} justify-between gap-4 w-full pt-4 `}>
