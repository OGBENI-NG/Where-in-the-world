...
type StoreItemProps = {
  ...
  cart: ThreeStoreData[]; // Array of items in the cart
  addToCart: (item: ThreeStoreData) => void; // Function to add item to the cart
  updateItemQuantity: (item: ThreeStoreData) => void; // Function to increase the item quantity in the cart
  removeFromCart: (item: ThreeStoreData) => void; // Function to decrease the item quantity in the cart
};
        ...
        <div className='relative bg-Lightest mt-3 pt-4 rounded-lg'>
          <div className='flex flex-col justify-center items-center group'>
            ...
            >
              ...
              />
              <div className={`absolute top-0 left-0 right-0 bottom-[52px] w-full overflow-hidden
                text-Darkest bg-Lightest/70 rounded-t-lg z-10 transition-opacity duration-300
            ...
            <div className={`${isHoverStyle} -mt-[18px]  relative z-20 `}>
              {showIncrement[item.id] ? (
                <div className='flex items-center justify-center gap-8 bg-Brand
                  ...
                  <button
                    ...
                    <span className='text-[14px] size-4 leading-none'>
